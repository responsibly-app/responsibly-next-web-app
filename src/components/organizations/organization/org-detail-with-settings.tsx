...
export function OrgDetailWithSettings({ orgId }: { orgId: string }) {
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3">
            {fullOrg.logo ? (
              <img src={fullOrg.logo} alt={fullOrg.name} className="size-10 rounded-lg object-cover" />
            ) : (
            ...
            <div>
              <h1 className="text-xl font-semibold">{fullOrg.name}</h1>
